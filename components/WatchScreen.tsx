      ...
      >
        <div className="w-full h-full px-[8%] py-[6%] font-mono flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-[3px] mb-[5%]">
            ...
            <span className="text-[7px] sm:text-[8px] text-white/80 font-semibold">Claude Code</span>
          </div>
          ...
          <div className="space-y-[4px] flex-1">
            ...
            <div className="whitespace-nowrap">
              <span className="text-white/40 text-[7px] sm:text-[8px]">{">"} </span>
              <span className="text-white/60 text-[7px] sm:text-[8px] italic">fix auth bug...</span>
            </div>
            <div className="whitespace-nowrap mt-[2px]">
              <span className="text-cyan-400 text-[7px] sm:text-[8px]">Read </span>
              <span className="text-white/60 text-[7px] sm:text-[8px]">server/auth.ts</span>
            </div>
            <div className="whitespace-nowrap">
            ...
            <div className="whitespace-nowrap">
              <span className="text-white/30 text-[6px] sm:text-[7px]">  {"✓"} Updated JWT exp</span>
            </div>
            <div className="whitespace-nowrap">
            ...
            <div className="whitespace-nowrap">
              <span className="text-green-400 text-[7px] sm:text-[8px]">  {"✓"} </span>
              <span className="text-white/70 text-[7px] sm:text-[8px]">14 tests passed</span>
            </div>
          </div>
          ...
          <div className="mt-auto pt-[3%]">
            <span className="text-white/40 text-[7px] sm:text-[8px]">{">"} </span>
            <span className="animate-blink text-orange-400 text-[7px] sm:text-[8px]">▊</span>
          </div>
        </div>
      </div>
    </div>
